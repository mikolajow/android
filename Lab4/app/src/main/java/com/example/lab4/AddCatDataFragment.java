...
public class AddCatDataFragment extends Fragment {
    ...
    private AddCatDataFragmentCommunication activityCommunicator;

    private EditText nameInput;
    private ToggleButton vaccinatedToggleButton;
    private CheckBox racialCheckBox;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            Toast.makeText(getContext(), savedInstanceState.getString(getString(R.string.cat_name_key)), Toast.LENGTH_LONG).show();
        }
        ...
        racialCheckBox = (CheckBox) view.findViewById(R.id.cat_checkbox);
    ...
    public interface AddCatDataFragmentCommunication {
    ...
    public void onAttach(Context context) {
        ...
        activityCommunicator = (AddCatDataFragmentCommunication) getActivity();
    }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        activityCommunicator.UpdateCatData(nameInput.getText().toString(), vaccinatedToggleButton.isChecked(), racialCheckBox.isChecked());
    }
